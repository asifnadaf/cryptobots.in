...
@section('content')
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header text-capitalize">Edit - Market odds </h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                {!! Form::model($altcoinData, ['method' => 'PATCH','route' => ['odds.update', $altcoinData->id]]) !!}
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::select('isSellingOnEqualOddsPaused', $pauseTradingOptions, $altcoinData->isSellingOnEqualOddsPaused, array('placeholder' => 'Select option', 'class' => 'form-control')) }}
