...
@section('content')
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">LTC - Koinex Up Bittrex Down&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    @if(!empty($result))
                                        <tr>
                                            <td>1. {{ $result['instructions']['LTC_KoinexUp_BittrexDown']['firstTransaction'] }}</td>
                                        </tr>
                                        <tr>
                                            <td>2. {{ $result['instructions']['LTC_KoinexUp_BittrexDown']['secondTransaction'] }}</td>
                                        </tr>
                                        <tr>
                                            <td>3. {{ $result['instructions']['LTC_KoinexUp_BittrexDown']['thirdTransaction'] }}</td>
                                        </tr>
                                    @endif
                                    </tbody>
                                </table>
