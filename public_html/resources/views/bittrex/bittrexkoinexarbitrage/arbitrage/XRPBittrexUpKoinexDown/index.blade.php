...
@section('content')
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">XRP - Bittrex Up Koinex Down&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    @if(!empty($result))
                                        <tr>
                                            <td>1. {{ $result['instructions']['XRP_BittrexUp_KoinexDown']['firstTransaction'] }}</td>
                                        </tr>
                                        <tr>
                                            <td>2. {{ $result['instructions']['XRP_BittrexUp_KoinexDown']['secondTransaction'] }}</td>
                                        </tr>
                                        <tr>
                                            <td>3. {{ $result['instructions']['XRP_BittrexUp_KoinexDown']['thirdTransaction'] }}</td>
                                        </tr>
                                    @endif
                                    </tbody>
                                </table>
