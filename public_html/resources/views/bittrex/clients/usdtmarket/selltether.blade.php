...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Buy Altcoin / Sell USDT Tether</h1>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                {!! Form::open( array('action' => ['BittrexExchange\Clients\USDTMarketController@sellTether'], 'method' => 'PATCH')) !!}
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="alert alert-info fade in">Please enter USDT rate.</label>
                        {{ Form::text('rate', null, array('placeholder' => 'Enter USDT rate', 'class' => 'form-control')) }}
