...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Cancel - Buy Altcoin / Sell USDT Tether</h1>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                {!! Form::open( array('action' => ['BittrexExchange\Clients\USDTMarketController@cancelSellTether'], 'method' => 'PATCH')) !!}
                <fieldset>
