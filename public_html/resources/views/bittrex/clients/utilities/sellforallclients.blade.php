...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-6">
            {!! Form::open( array('action' => ['BittrexExchange\Clients\ClientsUtilitiesController@sellForAllClients'], 'method' => 'PATCH')) !!}
            <fieldset>
                    ...
                    <div class="form-group">
                        <label class="alert alert-info fade in">Please enter sell price for market name.</label>
                        {{ Form::text('rate', null, array('placeholder' => 'Enter sell price', 'class' => 'form-control')) }}
