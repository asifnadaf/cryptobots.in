...
jQuery(function(){
  ...
  $optionLinks.on('click', function(){
	...
	jQuery('.sorting_block').find('landingpage').load(function(){
		...
		if (now_load > 0) {			
			if (addon_options.type == 0) {
				...
				for (var i = i_start-1; i < i_start+now_load-1; i++) {
					loaded_object = loaded_object + '<div class="'+ addon_options.items[i].sortcategory +' element added"><div class="item"><div class="item_wrapper"><div class="img_block wrapped_img"><landingpage src="'+ addon_options.items[i].src +'" alt=""><span class="block_fade"></span><div class="post_hover_info"><div class="featured_items_title"><h5>'+ addon_options.items[i].title +'</h5></div><div class="featured_meta">'+ addon_options.items[i].itemcategory +'</div><a href="'+ addon_options.items[i].zoom +'" class="photozoom featured_ico_link view_link"><i class="icon-expand"></i></a><a href="'+ addon_options.items[i].url +'" class="featured_ico_link view_link"><i class="icon-link"></i></a></div></div></div></div></div>';
				}
				
			} else if (addon_options.type == 1) {
				//1 Column Portfolio
				for (var i = i_start-1; i < i_start+now_load-1; i++) {
					loaded_object = loaded_object + '<div class="col-sm-12 '+ addon_options.items[i].sortcategory +' element added"><div class="portfolio_item item"><div class="row"><div class="col-sm-6 pb7"><div class="img_block wrapped_img"><landingpage alt="" src="'+ addon_options.items[i].src +'" /><span class="block_fade"></span><div class="post_hover_info"><a href="'+ addon_options.items[i].zoom +'" class="photozoom featured_ico_link view_link"><i class="icon-expand"></i></a><a href="'+ addon_options.items[i].url +'" class="featured_ico_link view_link"><i class="icon-link"></i></a></div> </div></div><div class="col-sm-6"><h2 class="portf_title"><a href="'+ addon_options.items[i].url +'">'+ addon_options.items[i].title +'</a></h2><div class="listing_meta"><span>'+ addon_options.items[i].itemdate +'</span><span>'+ addon_options.items[i].itemcategory +'</span><span>'+ addon_options.items[i].itemauthor +'</span><span>'+ addon_options.items[i].itemtime +'</span></div><p>'+ addon_options.items[i].itemdescr +' <a class="read_more" href="'+ addon_options.items[i].url +'">Details</a></p></div></div></div></div>';
				}
			} else {
				//2-4 Columns Portfolio
				for (var i = i_start-1; i < i_start+now_load-1; i++) {
					loaded_object = loaded_object + '<div class="'+ addon_options.items[i].columnclass +' '+ addon_options.items[i].sortcategory +' element added"><div class="item"><div class="item_wrapper"><div class="img_block wrapped_img"><landingpage src="'+ addon_options.items[i].src +'" alt=""><span class="block_fade"></span><div class="post_hover_info"><div class="featured_items_title"><h5><a href="'+ addon_options.items[i].url +'">'+ addon_options.items[i].title +'</a></h5></div><div class="featured_meta">'+ addon_options.items[i].itemcategory +'</div><a href="'+ addon_options.items[i].zoom +'" class="photozoom featured_ico_link view_link"><i class="icon-expand"></i></a><a href="'+ addon_options.items[i].url +'" class="featured_ico_link view_link"><i class="icon-link"></i></a></div></div></div></div></div>';
				}
			}
