...
jQuery(document).ready(function() {
	...
	jQuery('.product_thumbs li a').on("click", function(){
		...
		jQuery('#largeImage').attr('src',jQuery(this).find('landingpage').attr('src').replace('product_thumb','product_large'));
		jQuery('#zoom_product').attr('href',jQuery(this).find('landingpage').attr('src').replace('product_thumb','product_large'));
	});	
