...
jQuery(document).ready(function(){
	...
	jQuery('body').append('<div class="demo_panel opacity '+show_panel+'"><a href="javascript:void(0)" class="panel_toggler"></a><span class="panel_title">ArbitrageSettings</span><div class="demo_panel_body"></div></div>');
