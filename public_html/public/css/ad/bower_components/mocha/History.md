...
==================
  ...
  * fix row-side API to match node-side [jfirebaugh]
...
==================
  ...
  * Added `mocha init <path>` to copy row files
...
==================
  ...
  * Fixed: allow callback for `mocha.run()` in row version
...
==================
  ...
  * Added guillermo's row-side EventEmitter. Closes #132
